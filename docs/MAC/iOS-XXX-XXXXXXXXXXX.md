...
<table  border="0"> 
  ...
  <tr><td>学历：XXXXXX</td><td>专业：计算机科学与技术</td></tr>
...
- 音视频
  ...
  - H.264视频编码原理
- 熟悉组件化开发，了解CocoaPods。部分代码抽取创建私有仓库使用组件化开发，使用pod管理。
...
- 开发轮播图组件，占位图组件，分区加圆角和阴影的tableView组件。
- 带阴影、圆角和三角指示的下拉框。
...
### 北京云财信息技术有限公司（2023年11月 ~ 2024年11月）
...
- **项目简介**：一款个人财务管理应用，允许用户跟踪和规划日常开销，提供直观的数据可视化和简单易用的交互界面。
