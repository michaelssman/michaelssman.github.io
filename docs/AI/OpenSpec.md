...
比Vibe Coding更加规范，流程更清晰，项目不会轻易的失控。

没有规范和约束的话，Vibe Coding可能会修改其它的业务代码，产生负面的影响。

## 流程

1. 创建提案proposal.md
2. 实现变更apply.md。让AI实现代码。
3. 归档完成archive.md
4. 完成部署spec更新。归档完成会更新spec说明。

在多人开发时，最好都要使用OpenSpec。
...
*   **“开放规范”通用概念**：搜索结果中也提到了作为通用术语的“开放规范”，它指由标准化组织公开制定、可供多方实施的公开技术标准。这与你问的 **OpenSpec 框架是两回事**。
*   **R语言包 `OpenSpecy`**：这是一个用于光谱分析的专业R语言工具包，与AI编程无关。
...
如果你已经开始尝试使用 OpenSpec，在哪个使用阶段遇到了具体问题，或者想了解它如何与你现在使用的特定 AI 编码助手配合，我可以提供更详细的说明。