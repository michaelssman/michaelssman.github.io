...
到目前为止，认证服务颁发jwt令牌，客户端携带jwt访问资源服务，资源服务对jwt的合法性进行验证。如下图：

![2503181457](assets/2503181457.png)

上面每一个微服务都校验令牌合法性，可以统一让网关校验令牌的合法性。

加上网关组件后如下图所示：

![2503181458](assets/2503181458.png)
...
我们了解了使用Spring Security进行认证授权的过程，下面实现用户认证功能。
...
在研究Spring Security的过程中是将用户信息硬编码，所以要屏蔽原来定义的UserDetailsService如下：
...
![463c797c-bb32-4e53-9a71-062f00e2cf07](assets/463c797c-bb32-4e53-9a71-062f00e2cf07.png)
...
![931015f5-c9c1-49be-812e-5d5ba712215c](assets/931015f5-c9c1-49be-812e-5d5ba712215c.png)
...
![a4c340ea-0095-43c7-a704-7b469063a657](assets/a4c340ea-0095-43c7-a704-7b469063a657.png)
...
![img](https://mx67xggunk5.feishu.cn/space/api/box/stream/download/asynccode/?code=MWY0ZjczMTQ0ODcwM2U2ZDUyZWQ4MDI0NTRjYzZjNmJfTnVJelR1RDRqZ3NHQXdjWHk1Q0RwR1pvTjFMUTl3SEJfVG9rZW46WGx5RWJVeVg2b1Q4dHd4eEFDMGNIZ01Obm5oXzE3NDIzMDY2OTg6MTc0MjMxMDI5OF9WNA)
